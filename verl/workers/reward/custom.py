...
from verl.utils.reward_score import math_compute_score, vqa_compute_score
...
class VQARewardManager:
    def __init__(self, tokenizer: PreTrainedTokenizer, num_examine: int, compute_score: str):
        self.tokenizer = tokenizer
        self.num_examine = num_examine
        self.compute_score = vqa_compute_score
    ...
    def __call__(self, data: DataProto) -> torch.Tensor:
        ...
        for i in range(len(data)):
            ...
            answer_key = "correct_choice_idx" if "correct_choice_idx" in data_item.non_tensor_batch else "answer"
